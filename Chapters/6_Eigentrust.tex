\label{eigentrust_section}
	...
	\end{itemize}
	{
		...
		\begin{algorithm}[H]
			...
			\SetAlgoLined
			\For{community i}{
				get transactions and eigentrusts of the customers belonging to the i\;
				construct customers versus products matrix using transactions\;
				construct trust matrix using the eigentrusts\;
				construct similarity matrix based on cosine similarity between customers belonging to the i\;
